const i18n = {
  zh: {
    ...
    heroTitle: '把算力交易从“信任叙事”升级为“证据叙事”。',
    heroSubtitle:
      'Hyperion 聚焦可验证算力市场：订单、执行、结果与结算全链路可解释。这个博客不仅展示功能，更展示理念、方法论与可复现执行力。',
    heroCta1: '查看核心功能',
    heroCta2: '阅读研发日志',
    kpi1Label: '可复现演示链路',
    ...
    visionTitle: '项目理念',
    visionDesc: '不是“再做一个算力平台”，而是定义下一代可验证算力交易协议。',
    v1t: '1. 可验证优先',
    v1d: '交付结果必须可追溯、可审计、可复盘，执行证据是产品核心资产。',
    v2t: '2. 工程可落地',
    v2d: '坚持用可运行 Demo 验证假设，用真实链路替代 PPT 叙事。',
    v3t: '3. 经济可解释',
    v3d: '矿工收益、平台费用、财库分配透明可见，建立长期机制信任。',
    featuresTitle: '功能全景',
    ...
    f3c: '治理提案与投票接口',
    visualTitle: '科技感图示',
    visualDesc: '用流程图和能力图把系统机制直观呈现给国际评审。',
    flowTitle: '任务执行流程图',
    flow1: '提交订单',
    flow2: '矿工接单',
    flow3: '执行计算',
  ...
  en: {
    ...
    tagline: 'Scholarship-Ready Build Narrative',
    heroTitle: 'Upgrade compute trading from trust narrative to evidence narrative.',
    heroSubtitle:
      'Hyperion focuses on a verifiable compute market with end-to-end explainability: order, execution, results, and settlement. This blog presents capabilities, principles, and execution evidence.',
    ...
    visionDesc: 'Not another compute marketplace, but a next-generation protocol for verifiable compute delivery.',
    v1t: '1. Verification First',
    v1d: 'Delivery must be traceable, auditable, and replayable. Execution evidence is the product asset.',
    v2t: '2. Engineering Grounded',
    v2d: 'Validate assumptions through running demos, not slideware.',
    v3t: '3. Explainable Economics',
    v3d: 'Miner payout, platform fee, and treasury split are transparent to create mechanism trust.',
    ...
    visualDesc: 'Flow and capability graphics for quick understanding by international reviewers.',
    ...
    roadDesc: 'From demo validation to real workload pilots and paid validation.',
    ...
    logTitle: 'Build Logs',
    logDesc: 'Track major decisions, failure retrospectives, and execution evidence.',
    footer: 'Hyperion Project Blog · Built for scholarship and investor-level technical review.',
    close: 'Close',
    readMore: 'Read More',
    allFilter: 'All',
