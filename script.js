const i18n = {
  zh: {
    ...
    d3: '任务输出自动回传并可下载',
    d4: '分账结果在界面即时展示',
    structureTitle: '项目结构图',
    structureDesc: '这张图对应“谁在使用、系统如何调度、如何验证、如何结算”的完整路径。',
    sFlowTitle: '系统分层与流转',
    s1: '接入层：Web UI / API / SDK',
    s2: '交易层：订单簿、动态定价、任务调度',
    s3: '执行层：矿工执行、结果回传、争议判定',
    s4: '结算层：收益分账、平台费、财库治理',
    sMapTitle: '模块映射（核心代码域）',
    sm1h: '订单与市场：',
    sm1d: 'compute_market_orderbook / dynamic_pricing / compute_scheduler',
    sm2h: '执行与验证：',
    sm2d: 'pouw_executor / task_acceptance / arbitration / zk_verification',
    sm3h: '安全与审计：',
    sm3d: 'miner_security_manager / attack_prevention / audit_compliance',
    sm4h: '结算与治理：',
    sm4d: 'revenue_tracking / protocol_fee_pool / dao_treasury / governance',
    sm5h: '网络与基础设施：',
    sm5d: 'message_queue / tcp_network / p2p_task_distributor / storage',
    archTitle: '架构拆解',
  ...
  en: {
    ...
    structureTitle: 'Project Structure Diagram',
    structureDesc: 'This view explains the full path: who uses it, how tasks are scheduled, how execution is verified, and how value is settled.',
    sFlowTitle: 'Layered System Flow',
    s1: 'Access Layer: Web UI / API / SDK',
    s2: 'Market Layer: Orderbook, dynamic pricing, task scheduling',
    s3: 'Execution Layer: Miner execution, result return, dispute verdict',
    s4: 'Settlement Layer: Revenue split, platform fee, treasury governance',
    sMapTitle: 'Module Mapping (Core Domains)',
    sm1h: 'Order & Market:',
    sm1d: 'compute_market_orderbook / dynamic_pricing / compute_scheduler',
    sm2h: 'Execution & Verification:',
    sm2d: 'pouw_executor / task_acceptance / arbitration / zk_verification',
    sm3h: 'Security & Audit:',
    sm3d: 'miner_security_manager / attack_prevention / audit_compliance',
    sm4h: 'Settlement & Governance:',
    sm4d: 'revenue_tracking / protocol_fee_pool / dao_treasury / governance',
    sm5h: 'Network & Infrastructure:',
    sm5d: 'message_queue / tcp_network / p2p_task_distributor / storage',
