const i18n = {
  zh: {
    ...
    fs5Title: '资源杠杆（Why Fellowship Capital Now）',
    fs5a: '我们已经在低资源条件下完成核心链路，不是“有想法但没执行”。',
    fs5b: '当前瓶颈是验证资源：真实 workload、GPU 时间、连续观测窗口。',
    fs5c: '资助将把已验证的执行力从 1x 放大到 10x，转化为可计量的市场证据。',
  ...
  en: {
    ...
    fs5Title: 'Resource Leverage (Why Fellowship Capital Now)',
    fs5a: 'We already built the core flow under severe constraints; this is not an idea without execution.',
    fs5b: 'The current bottleneck is validation resources: real workloads, GPU time, and continuous observation windows.',
    fs5c: 'Capital now turns proven execution from 1x into 10x by converting momentum into measurable market evidence.',
