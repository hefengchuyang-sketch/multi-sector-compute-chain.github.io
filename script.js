const i18n = {
  zh: {
    ...
    fellowshipTitle: 'Thiel Fellowship 申请叙事',
    fellowshipDesc: '采用早期以太坊申请博客那种“问题定义 -> 技术路径 -> 经济机制 -> 人类意义 -> 请求验证资源”的结构来讲清项目。',
  ...
  en: {
    ...
    navFellowship: 'Fellowship Narrative',
    ...
    scanTitle: 'Reviewer 30-Second Scan',
    ...
    fellowshipTitle: 'Thiel Fellowship Narrative',
    fellowshipDesc: 'Structured like the early Ethereum-style application blog: problem framing -> technical path -> economic mechanism -> human impact -> validation ask.',
